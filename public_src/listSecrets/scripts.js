...
const copyText = text => {
	return new Promise((resolve, reject) => {
		if (window.AndroidClipboard && typeof window.AndroidClipboard.copyToClipboard === 'function') {
			try {
				window.AndroidClipboard.copyToClipboard(text);
				console.log('Copied to clipboard via Android interface.');
				resolve();
			...
			console.log('Android clipboard interface not found. Trying native browser navigator to copy.');
